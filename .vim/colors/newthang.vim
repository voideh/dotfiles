...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	" Vim Highlighting
	call <SID>X("Normal", "600787","" , "")
	call <SID>X("LineNr", "806375", s:background, "")
	call <SID>X("NonText", s:selection, "", "")
	call <SID>X("SpecialKey", s:selection, "", "")
	call <SID>X("Search", s:background, s:yellow, "")
	call <SID>X("TabLine", "8abbce", "D8E1BE", "reverse")
	call <SID>X("TabLineFill", "8abbce", s:foreground, "reverse")
	call <SID>X("StatusLine", "279693", s:yellow, "reverse")
	...
	call <SID>X("String", "13237D", "", "")
	call <SID>X("Special", s:foreground, "", "")
	call <SID>X("PreProc", s:purple, "", "")
	call <SID>X("Operator", "135e7D", "", "none")
	call <SID>X("Type", "82378c", "", "none")
  ...
  " Java Specifics
  call <SID>X("javaType", "778dcd","","none")
  call <SID>X("javaExternal", "2fcf85","","none")
  call <SID>X("javaConditional", "6282c6","","none")
  call <SID>X("javaExceptions", "5b9e94","","none")
  call <SID>X("javaScopeDecl", "2997FF","","none")
  call <SID>X("javaStorageClass", "599e9d", "",  "none")
